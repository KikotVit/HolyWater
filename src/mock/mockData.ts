...
export const mockMainContent: (ICommonContent | IListSection)[] = [
    {
        ...
        items: [
            { 
                ...
                imageUrl: 'https://static.tnn.in/thumb/msid-106455842,thumbsize-1700636,width-1280,height-720,resizemode-75/106455842.jpg',
                episodes: [
                    {
                        id: '1',
                        title: 'Episode 1',
            ...
            },
            {
                ...
                imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcReAcQqCJJgcukr_Wfg-FCchaz2kpar_-wlVynWigN5qA&s',
                text: `Read book
...
As the days grew shorter and the nights cooler, I reflected on the season that had passed. Though summer may fade into memory, its warmth lingers in my heart, a beacon of light to guide me through the seasons to come. For in those fleeting moments of sunshine and laughter, I found the true essence of happiness: the simple joy of living in the moment.`,
            },
            {
                ...
                imageUrl: 'https://i0.wp.com/www.printmag.com/wp-content/uploads/2015/05/2a34d8_e255259e533245088b6ad325179d75e4mv2.png?fit=480%2C292&quality=80&ssl=1',
                text: `long-long-long poster title
        ...
        items: [
            {
                ...
                imageUrl: 'https://bloximages.newyork1.vip.townnews.com/tulsaworld.com/content/tncms/assets/v3/editorial/b/72/b72586b2-46a9-11ee-a5d0-cb68dc453177/64ee536b1f3a5.image.png?resize=333%2C500',
                isLocked: false,
                link: 'https://google.com',
            },
            {
                title: 'Beautiful Revenge',
                imageUrl: 'https://www.researchgate.net/publication/353611013/figure/fig2/AS:1051792834043904@1627778361041/Poster-for-the-film-Capernaum-directed-by-N-Labaki-2-2-See-the-image.png',
                comingDate: 'Coming July 2',
                isLocked: true,
            },
            {
                title: 'Sin De Rella',
                imageUrl: 'https://images.rawpixel.com/image_800/cHJpdmF0ZS9sci9pbWFnZXMvd2Vic2l0ZS8yMDIzLTAzL3drODU3MTE0MjQtaW1hZ2UuanBn.jpg',
                comingDate: 'Coming August 3',
                isLocked: true,
            },
            {
                title: 'New book!',
                imageUrl: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQHAQKO3JSBwBxh4Uw6kXbMhYPH59xYFNc-SW3DQu-Anw&s',
